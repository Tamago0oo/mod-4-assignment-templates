...
def shift_letter(letter: str, shift: int):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    if letter == " ":
        ...
        return ''.join(chr((ord(char) - 97 + shift) % 26 + 97) for char in letter.lower()).upper()
...
def caesar_cipher(message: str, shift: int):
    ...
    for i in message:
        if i == " ":
            ...
            result = result+ ''.join(chr((ord(char) - 97 + shift) % 26 + 97) for char in i.lower()).upper()
    return result
...
def shift_by_letter(letter: str, letter_shift: str):
    ...
    if letter == " ":
        ...
        result = ((ord(letter.upper()) - 65 + shift) % 26 + 65)
        return chr(result)
